...
def proposta_titular2():
    st.title("📄 2º Titular – Dados")
    ...
    with st.form("form_titular2"):
        ...
        for doc in documentos:
            ...
            with col1:
                estado = st.selectbox(f"{doc}", ["OK", "FALTA"], key='t2_'+doc)
            with col2:
                obs = st.text_input(f"Observações {doc}", key='t2_'+doc + "_obs")
